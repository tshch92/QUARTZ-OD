  ...
  plugins: [
    ...
    new CopyWebpackPlugin({
      patterns: [
        ...
        {
          from: path.resolve(environment.paths.source, 'downloads'),
          to: path.resolve(environment.paths.output, 'downloads'),
          toType: 'dir',
          globOptions: {
            ignore: ['*.DS_Store', 'Thumbs.db'],
          },
        ...
        {
          from: path.resolve(environment.paths.source, 'slick'),
          to: path.resolve(environment.paths.output, 'slick'),
          toType: 'dir',
          globOptions: {
            ignore: ['*.DS_Store', 'Thumbs.db'],
          },
